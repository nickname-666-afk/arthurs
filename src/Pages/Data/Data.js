		...
		<div className="Data">
			...
			<div className="text">
				<div className="wrapper-text">
					...
					<div className="p">
						Звоните нам <br /> +7 958 756-80-39 <br />и администратор оперативно
						забронирует для Вас номер в нашем отеле. Вы также можете
						воспользоваться формой бронирования.
					</div>
				</div>
			</div>
		</div>
